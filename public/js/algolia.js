(() => {
  ...
  var params = { algolia: { enabled: true }, keywords: ["whatsupdate", "whatsupdate.netlify.app", "whatsupdate. com", "whatsupdate.netlify .app", "news", "live news", "big news", "world news", "technology"], showcopyright: true };
